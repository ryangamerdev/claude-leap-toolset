...
1. Restart onto scroll-effect evidence candidate; compare scoped sidebar wheel evidence with screenshots and a deliberate drag control. Confirm unchanged content never implies failed delivery or a reached boundary; exercise evidence retrieval. Then continue iPhone. iPad mac_ax field zoom/reset/pan and foreground sidebar drag scrolling now passed native visual checks; window bounds remained stable. Wheel input had no effect even foregrounded. Continue paired Sky/Leap iPhone landscape navigation and scrolling from fresh observations, then desktop coach/create/save/reopen. Use explicit drag when testing touch-style scroll; retain wheel limitation separately. The last Sky field drag had no confirmed movement, so it is not a successful comparison baseline. See [native checkpoint](iterations/2026-09-20-ipad-pointer-native.md). WDA remains optional; no speculative rotation experiments.

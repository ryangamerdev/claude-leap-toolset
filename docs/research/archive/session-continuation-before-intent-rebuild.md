...
Read [PLAN.md](../../PLAN.md) for execution order, [FEATURES.md](../../FEATURES.md) for status, and [observation-session-design.md](../observation-session-design.md) for architecture. Older handoff archived under [research/archive](session-continuation-before-20260920-review.md); its paths, process IDs, assertions and instructions are superseded.
...
[Scroll](../trial-scroll-details.md), [navigation](../trial-navigation-details.md), [editor incident](../trial-editor-details.md), [field](../trial-field-details.md), [coach baseline](../trial-sky-details.md), [Leap replay](../trial-leap.details.md). The full historical pass is not a substitute for the specific changed-route or ambiguous-error tests still pending.

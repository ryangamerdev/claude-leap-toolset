...
Latest development checkpoint: Mac capture passed after restart, but the intent coordinate guard rejected live CGFloat bounds before input. Numeric normalization is corrected in the next installed candidate; field zoom/drag acceptance must be rerun after restart.

...
try:
    ...
    raise
subprocess.run([os.sys.executable, str(root / 'scripts/install.py'), '--skills-only'], check=True)
...
(root / 'artifacts/test-runs/20260920-interaction-deltas/install.json').write_text(json.dumps(metadata, indent=2) + '\n')
